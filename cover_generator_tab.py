...
class CoverGeneratorTab(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.artwork_info.setStyleSheet("color: #B0B0B0; font-size: 11px;")
        ...
        self.icon_info.setStyleSheet("color: #B0B0B0; font-size: 11px;")
        ...
        preview_label.setStyleSheet("font-size: 14px; font-weight: bold; color: #FFFFFF;")
